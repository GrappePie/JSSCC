...
function inject(){
  ...
  const refreshDestination=()=>{a.href=destination(id);};
  a.addEventListener('pointerdown',refreshDestination);
  a.addEventListener('click',refreshDestination);
  a.addEventListener('auxclick',refreshDestination);
